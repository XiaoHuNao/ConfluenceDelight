...
public class JuicerInfoProvider  implements IBlockComponentProvider, IServerDataProvider<BlockAccessor> {
    public static final JuicerInfoProvider INSTANCE = new JuicerInfoProvider();
    public static final ResourceLocation UID = ConfluenceDelight.asResource("juicer_info");
    ...
    public void appendServerData(CompoundTag compoundTag, BlockAccessor accessor) {
        if (accessor.getBlockEntity() instanceof JuicerBlockEntity entity) {
