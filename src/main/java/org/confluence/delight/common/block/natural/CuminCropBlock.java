...
public class CuminCropBlock extends CropBlock {
    ...
    public InteractionResult useWithoutItem(BlockState state, Level level, BlockPos pos, Player player, BlockHitResult hit) {
        ...
        if (isMature) {
            ...
            popResource(level, pos, new ItemStack(FoodItems.PINEAPPLE.get(), quantity));
