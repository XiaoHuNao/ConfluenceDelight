...
public class ModFoodItems {
    ...
    public static final DeferredItem<BaseFoodItem> DONKEY_MEAT_FIRE = registerNormalFood("donkey_meat_fire", "驴肉火烧", DelightFoodProperties.hasEffectProperties(10, 0.6f, ModEffects.HUNGER_DELAYED, 3600, 0));
    public static final DeferredItem<BaseFoodItem> HORSE_MEAT_SASHIMI = registerNormalFood("horse_meat_sashimi", "马肉刺身", DelightFoodProperties.hasEffectProperties(8, 0.5625f, MobEffects.MOVEMENT_SPEED, 3600, 1));
    public static final DeferredItem<BaseFoodItem> BLACK_LUCK = registerToolTipFood("black_luck", "黑色幸运", builder -> builder.food(DelightFoodProperties.hasEffectProperties(4, 0.5f, MobEffects.LUCK, 1800, 0)).duration(d -> 15).useAnim(u -> UseAnim.DRINK).eatingSound(s -> SoundEvents.GENERIC_DRINK), 1, ChatFormatting.GRAY);
    public static final DeferredItem<BaseFoodItem> WHITE_DAWN = registerToolTipFood("white_dawn", "白色曙光", builder -> builder.food(DelightFoodProperties.hasEffectProperties(4, 0.5f, ModEffects.MANA_REGENERATION, 1800, 0)).duration(d -> 15).useAnim(u -> UseAnim.DRINK).eatingSound(s -> SoundEvents.GENERIC_DRINK), 1, ChatFormatting.GRAY);
