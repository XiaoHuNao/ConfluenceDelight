...
public class ModItems {
    ...
    public static final DeferredHolder<Item, Item> WINE_BUCKET = register("wine_bucket", "酒桶", () -> new BucketItem(ModFluids.WINE.fluid().get(), new Item.Properties().craftRemainder(Items.BUCKET).stacksTo(1)));

    private static DeferredHolder<Item, Item> register(final String en, final String zh, Supplier<? extends Item> item) {
        return ModMaterialItems.register(en, zh, item);
    }
